...
bool DunmapLayer::init() {
	if (!Layer::init()) {
		return false;
	}

	auto info = Sprite::create("dun_info.png");
	...
	auto enter = MenuItemImage::create("enter.png", "enter_push.png", CC_CALLBACK_1(DunmapLayer::onTouchBegan, this));
	auto close = MenuItemImage::create("close.png", "close_push.png", CC_CALLBACK_1(DunmapLayer::onCloseTouchBegan, this));
...
void DunmapLayer::onTouchBegan(cocos2d::Ref *sender) {

	Director::getInstance()->replaceScene(GameScene::createScene());
}

void DunmapLayer::onCloseTouchBegan(cocos2d::Ref *sender) {
